new EventSource('http://127.0.0.1:54882/esbuild').addEventListener('change', () => location.reload())
import {
  __commonJS,
  __require,
  __toESM,
...
function EditorPage() {
  ...
  const Editor = (0, import_react64.useMemo)(() => {
    return (0, import_dynamic.default)(() => import("./Editor-EV24R7VG.js"), {
