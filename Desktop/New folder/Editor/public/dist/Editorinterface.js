...
var $ae1eeba8b9eafd08$export$5165eccb35aaadb5 = (0, import_react7.default).createContext({
  register: () => {
  }
});
...
function $f6c31cce2adf654f$var$usePressResponderContext(props) {
  let context = (0, import_react8.useContext)((0, $ae1eeba8b9eafd08$export$5165eccb35aaadb5));
  if (context) {
...
function $f6c31cce2adf654f$export$45712eceda6fad21(props) {
  ...
  let [isPressed, setPressed] = (0, import_react8.useState)(false);
  ...
  let pressProps = (0, import_react8.useMemo)(() => {
    let state = ref.current;
    let pressProps2 = {
      onKeyDown(e) {
...
function $8a9cb279dc87e130$export$715c682d09d639cc(onBlur) {
  let stateRef = (0, import_react9.useRef)({
    isFocused: false,
    observer: null
  });
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
  ...
  return (0, import_react9.useCallback)((e) => {
...
var $e6afbd83fe6ebbd2$var$FocusableContext = /* @__PURE__ */ (0, import_react15.default).createContext(null);
...
function useVisualElement(Component2, visualState, props, createVisualElement) {
  ...
  const wantsHandoff = (0, import_react21.useRef)(Boolean(props[optimizedAppearDataAttribute] && !window.HandoffComplete));
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component2, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component2 !== import_react29.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react34.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent }) {
  const id2 = (0, import_react35.useId)();
  ...
  const { nonce } = (0, import_react35.useContext)(MotionConfigContext);
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const forceRender = (0, import_react38.useContext)(LayoutGroupContext).forceRender || useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react38.useRef)(/* @__PURE__ */ new Map()).current;
  ...
  return (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react38.cloneElement)(child)) });
};
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react39.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react39.useRef)(void 0);
...
function forwardRef2(component) {
  return (0, import_react40.forwardRef)(component);
}
...
var Ripple = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: ripples.map((ripple) => {
    const duration = clamp(0.01 * ripple.size, 0.2, ripple.size > 100 ? 0.75 : 0.5);
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(LazyMotion, { features: domAnimation, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AnimatePresence, { mode: "popLayout", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      m.span,
      {
...
function useRipple(props = {}) {
  const [ripples, setRipples] = (0, import_react41.useState)([]);
  const onClick = (0, import_react41.useCallback)((event) => {
  ...
  const onClear = (0, import_react41.useCallback)((key) => {
...
function useCard(originalProps) {
  ...
  const getCardProps = (0, import_react42.useCallback)(
    (props2 = {}) => {
      return {
        ref: domRef,
  ...
  const getRippleProps = (0, import_react42.useCallback)(
...
var Card = forwardRef2((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Component2, { ...getCardProps(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(CardProvider, { value: context, children }),
    isPressable && !disableAnimation && !disableRipple && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ripple_default, { ...getRippleProps() })
  ] });
});
...
function EditorPage() {
  const [currentRoom, setCurrentRoom] = (0, import_react43.useState)("default");
  const userColor = (0, import_react43.useMemo)(() => getRandomColor(), []);
  const Editor = (0, import_react43.useMemo)(() => {
    return (0, import_dynamic.default)(() => import("./Editor-K2CVLGVT.js"), {
      loading: () => /* @__PURE__ */ import_react43.default.createElement("p", null, "Loading..."),
      ssr: false
    });
  }, []);
  return /* @__PURE__ */ import_react43.default.createElement(import_react43.default.Fragment, null, /* @__PURE__ */ import_react43.default.createElement("div", { style: { display: "flex", height: "100vh" } }, /* @__PURE__ */ import_react43.default.createElement(card_default, { style: { width: "20%", padding: "10px" } }), /* @__PURE__ */ import_react43.default.createElement(card_default, { style: { width: "60%", padding: "20px" } }, /* @__PURE__ */ import_react43.default.createElement(Editor, { key: currentRoom, room: currentRoom, userColor })), /* @__PURE__ */ import_react43.default.createElement(card_default, { style: { width: "20%", padding: "10px" } })));
}
export {
